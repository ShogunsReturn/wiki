...
| --------- | ------------------------------------------------------ | ------------------------------------------------------------- | -------------------------------------------------------------------------------- | ----------------------------------------------------- | -------------------------------------------------------- |
| Knowledge | Increases resource production by up to 20%.            | Up to 30% discount on the cost of political actions.          | Up to 20% discount on the cost of ninja missions.                                | Reduces army travel time by up to 15%.                | The samurai will increase their damage in battle.        |
| Reasoning | Reduces construction costs by up to 25%.               | Reduces cooldown times of political abilities by up to 30%.   | Reduces ninjutsu mission times by up to 30%.                                     | Reduces unit maintenance costs by up to 20%.          | Reduces damage taken by units by up to 30%.              |
| Charisma  | Increases gold collection from villagers by up to 30%. | Increases the effect of political actions by up to 30%.       | Ninjas will fill vacant slots up to 25% faster.                                  | Your armies will defend the capital up to 20% better. | +1 morale for every 20 charisma points (up to +5 total). |
| Picardy   | Increases theft protection by up to 30 points.         | Reduces activation times of political abilities by up to 30%. | Your ninjas will have up to 25% higher chances of survival when making mistakes. | Units will complete their training up to 25% faster.  | Greater survival in battle.                              |
