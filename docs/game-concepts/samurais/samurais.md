...
| --------- | ------------------------------------------------------ | ------------------------------------------------------------- | -------------------------------------------------------- | ----------------------------------------------------- | -------------------------------------------------------------------------------- |
| Knowledge | Increases resource production by up to 20%.            | Up to 30% discount on the cost of political actions.          | The samurai will increase their damage in battle.        | Reduces army travel time by up to 15%.                | Up to 20% discount on the cost of ninja missions.                                |
| Reasoning | Reduces construction costs by up to 25%.               | Reduces cooldown times of political abilities by up to 30%.   | Reduces damage taken by units by up to 30%.              | Reduces unit maintenance costs by up to 20%.          | Reduces ninjutsu mission times by up to 30%.                                     |
| Charisma  | Increases gold collection from villagers by up to 30%. | Increases the effect of political actions by up to 30%.       | +1 morale for every 20 charisma points (up to +5 total). | Your armies will defend the capital up to 20% better. | Ninjas will fill vacant slots up to 25% faster.                                  |
| Picardy   | Increases theft protection by up to 30 points.         | Reduces activation times of political abilities by up to 30%. | Greater survival in battle.                              | Units will complete their training up to 25% faster.  | Your ninjas will have up to 25% higher chances of survival when making mistakes. |
